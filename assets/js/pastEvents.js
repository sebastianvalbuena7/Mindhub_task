// Variables
const cardEvents = document.getElementById('cards-past')
    ...
    event.map(property =>  {
        ...
        if(date < dateFetch) {
            ...
            infoCards.innerHTML = `
                ...
                `
            cardEvents.appendChild(infoCards)
        }
    })
}
...
function limpiarHTML() {
    while(cardEvents.firstChild) {
        cardEvents.removeChild(cardEvents.firstChild)
    }
}